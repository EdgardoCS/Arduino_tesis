...
def old():
    pass
    # calibration_sequence(serial_port)

    # Testing different distances and speeds
    # distance = 100
    # speed = 250
    # total_time = distance / speed
    # print(f'Moving {distance} mm at {speed} mm/s. Time: {total_time:.2f} s.')
    # steps, mtime = get_steps_time(distance, speed, 2)
    # do_brushing(serial_port, steps, mtime)

    # Trying max speed, with commands generated by the API
    # Trace of 2 inches, with speed 12 inches per second
    ...
    # doXYMove(serial_port, 53, 53, 26)
    # doXYMove(serial_port, 106, 106, 27)
    # doXYMove(serial_port, 159, 159, 26)
    # doXYMove(serial_port, 1396, 1396, 174)
    # time.sleep(0.164)
    # doXYMove(serial_port, 159, 159, 26)
    # doXYMove(serial_port, 106, 106, 27)
    # doXYMove(serial_port, 53, 53, 26)
