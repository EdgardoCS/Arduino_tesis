'''
move axiDraw (MultiTAC) at zoomed window of speed
Former configuration : 3 10 30 50 100 200 mm/s
Actual configuration : 26 28 30 32 34 mm/s
'''
...
if __name__ == '__main__':
    ...
    speed1 = 1.02362  # 26 mm/s
    speed2 = 1.10236  # 28 mm/s
    speed3 = 1.1811  # 30 mm/s
    speed4 = 1.25984  # 32 mm/s
    speed5 = 1.33858  # 36 mm/s

    speed_list = [speed1, speed2, speed3, speed4, speed5]
    ...
    out_name = 'C:\Project\code_tesis\data/ParteII/rnd'
